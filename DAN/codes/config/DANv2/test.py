...
from data.__init__ import create_dataloader, create_dataset
from data.util import bgr2ycbcr

#### options
parser = argparse.ArgumentParser()
parser.add_argument("--opt", type=str, required=True, help="options/setting1/test/test_setting1_x4.yml")
...
for test_loader in test_loaders:
    ...
    for test_data in test_loader:
        ...
        sr_img = util.tensor2img(visuals["LQE"].squeeze())  # uint8
        ...
        # kernel = util.tensor2img(visuals['ker'].view(21,21), np.float32)
        

        # util.plot_kernel(kernel, "C:/Users/Dooly/Desktop/test/4.png")
        # sys.exit()
        # util.save_img(sr_img, save_img_path)
        ...
        if need_GT:
            gt_img = util.tensor2img(visuals["LQ"].squeeze())
            gt_img = gt_img / 255.0
            sr_img = sr_img / 255.0
